...
public:
    ...
    Vector2& operator=(const ImVec2& other) noexcept { x = other.x; y = other.y; return *this; }
...
public:
    ...
    Vector4& operator=(const ImVec4& other) noexcept { x = other.x; y = other.y; z = other.z; w = other.w; return *this; }
    Vector4& operator=(const Vector4& other) noexcept { x = other.x; y = other.y; z = other.z; w = other.w; return *this; }
    Vector4& operator=(const Vector4&& other) noexcept { x = other.x; y = other.y; z = other.z; w = other.w; return *this; }
    Vector4& operator=(const ImVec4&& other) noexcept { x = other.x; y = other.y; z = other.z; w = other.w; return *this; }
