...
void Logger::critical(const char* format, ...) {
    if (m_level > LogLevel::Critical) return;
...
const char* Logger::get_level_color(LogLevel level) const {
    switch (level) {
        case LogLevel::Debug:    return BRIGHT_CYAN;
        case LogLevel::Info:     return BRIGHT_GREEN;
        case LogLevel::Warning:  return BRIGHT_YELLOW;
        case LogLevel::Error:    return BRIGHT_RED;
        case LogLevel::Critical: return BRIGHT_MAGENTA;
